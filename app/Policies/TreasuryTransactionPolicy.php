...
class TreasuryTransactionPolicy
{
    ...
    {
        return $user->can('update_treasury::transaction');
    }
    ...
    {
        return $user->can('delete_treasury::transaction');
    }
    ...
    {
        return $user->can('delete_any_treasury::transaction');
    }
    ...
    {
        return $user->can('force_delete_treasury::transaction');
    }
    ...
    {
        return $user->can('force_delete_any_treasury::transaction');
    }
    ...
    {
        return $user->can('restore_treasury::transaction');
    }
    ...
    {
        return $user->can('restore_any_treasury::transaction');
    }
