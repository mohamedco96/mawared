...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('company.company_tax_number', GeneralSetting::getValue('company_tax_number', '123456789'));
        $this->migrator->add('company.company_commercial_register', GeneralSetting::getValue('company_commercial_register', '987654321'));
