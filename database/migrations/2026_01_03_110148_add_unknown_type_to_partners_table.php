...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            // Note: SQLite stores ENUM as TEXT, so it already accepts 'unknown'
            Schema::table('partners', function (Blueprint $table) {
                // No actual change needed for SQLite - it's already flexible
            });
        } else {
            // MySQL/MariaDB - use raw SQL to modify ENUM
            DB::statement("ALTER TABLE partners MODIFY COLUMN type ENUM('customer', 'supplier', 'shareholder', 'unknown') NOT NULL");
        }
    }
